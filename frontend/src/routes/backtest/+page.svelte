...
<div class="max-w-6xl mx-auto mt-4 px-4 sm:px-6 lg:px-8 py-8">
  <header class="mb-10">
    ...
    <p class="text-slate-500 max-w-3xl text-[15px] leading-relaxed">
      Análisis retrospectivo frente al Niño costero de 2017, el único desastre
      mayor que cae dentro del alcance de la Etapa 2 (Landsat 8 opera desde
      2013).
    </p>
  </header>
  ...
  <div class="grid grid-cols-1 gap-8">
    ...
    >
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8 mt-2">
          ...
          >
            ...
            <div class="text-[13px] text-slate-500 pl-2 leading-relaxed">
              El índice de DIAGNÓSTICO habría llegado tarde.
            </div>
          </div>
          ...
          >
            <div
              class="absolute left-0 top-0 bottom-0 w-1.5 bg-amber-500"
            ></div>
            <div
              class="text-[11px] font-bold tracking-widest text-slate-500 uppercase mb-2 pl-2"
            >
              Precursor Diario Pulso
            </div>
            <div
              class="text-3xl font-oswald font-bold text-slate-800 mb-2 pl-2"
            >
            ...
            <div class="text-[13px] text-slate-500 pl-2 leading-relaxed">
              Etapa 1 · alerta temprana el 18-ene-2017.
            </div>
          </div>

          <!-- Metric Card 3: Confirmación -->
          <div
            class="bg-white p-5 rounded-2xl shadow-[0_2px_10px_-3px_rgba(6,81,237,0.05)] border border-slate-200/60 relative overflow-hidden group hover:shadow-md transition-shadow"
          >
        ...
        <!-- Info Block -->
        <div
          class="flex items-start bg-slate-50/50 p-5 rounded-2xl border border-slate-100 mb-10"
        >
          <div class="text-slate-400 mr-4 mt-0.5">
            <svg
          ...
          <div class="text-[14px] text-slate-600 leading-relaxed">
            <span class="font-semibold text-slate-800"
              >Esta comparación no es contra el ENFEN.</span
            > El ICEN es un índice de DIAGNÓSTICO: sirve para declarar oficialmente
            que hubo un Niño costero, no para alertar de forma temprana. Lo que Pulso
            demuestra aquí es que la alta cadencia (diaria) recupera semanas vitales,
            pero el hallazgo central del proyecto está en la Etapa 2.
          </div>
        </div>
        ...
        <div class="max-w-4xl">
          ...
          >
            Por qué la anomalía oceánica no basta
          </h3>
